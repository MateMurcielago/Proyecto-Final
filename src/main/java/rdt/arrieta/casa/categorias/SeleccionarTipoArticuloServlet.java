...
@WebServlet("/seleccionarTipoArticulo")
public class SeleccionarTipoArticuloServlet extends HttpServlet {
    @Override
    protected  void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        request.getRequestDispatcher("seleccionarTipoArticulo.jsp").forward(request, response);
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        response.sendRedirect(request.getContextPath() + "/crearModeloArticulo?tipoId=" + tipoId);
    }
}

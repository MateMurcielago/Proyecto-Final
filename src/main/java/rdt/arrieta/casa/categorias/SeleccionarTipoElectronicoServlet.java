...
@WebServlet("/seleccionarTipoElectronico")
public class SeleccionarTipoElectronicoServlet extends HttpServlet {
    @Override
    protected  void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        request.getRequestDispatcher("seleccionarTipoElectronico.jsp").forward(request, response);
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        response.sendRedirect(request.getContextPath() + "/crearCodigoElectronico?tipoId=" + tipoId);
    }
}
